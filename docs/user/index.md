...
title: 从第一次输入开始
order: 0
description: 微明输入法使用文档（macOS、Windows 与 Linux 测试版）：安装、按键、译词与生词、云联想、词库、数据位置与卸载。
---
...
- 微明在本机保存了哪些文件：[数据与日志](help/data-and-logs.md)。

## 三条原则

- **输入优先。** 任何为学习功能增加的延迟、弹窗与干扰都视为设计错误。
- **一次只学一种语言。** 一个候选旁只有一条译词，不同时显示英语、日语、韩语。
- **全部在本机。** 拼音转换、词库、学习、释义均不联网；云联想是可选的补充，数据发送给用户自行填写的服务商，不经过微明。
