...
use glimmer_core::{Language, PartOfSpeech, Sense, Translation, Translator};
use glimmer_format::{Container, Kind, Metadata, Table, Writer, hash};
...
mod tests {
    ...
    fn qj_round_trip_keeps_every_sense() {
        ...
        let dir = std::env::temp_dir().join("glimmer-glossary-tests");
